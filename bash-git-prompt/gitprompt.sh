...
function git_prompt_config()
{
  ...
  if [[ -n "$__GIT_PROMPT_COLORS_FILE" && -f "$__GIT_PROMPT_COLORS_FILE" ]]; then
    ...
    PROMPT_START="${BoldGreen}${USER}@${BoldGreen}${HOSTNAME}$ResetColor:${BoldBlue}${PathShort}${ResetColor}"
    PROMPT_END="${ResetColor}$ "
    GIT_PROMPT_START="${BoldGreen}${USER}@${BoldGreen}${HOSTNAME}$ResetColor:${BoldBlue}${PathShort}${ResetColor}"
...
#    GIT_PROMPT_START_ROOT="${Cyan}${PathShort}${ResetColor}"
